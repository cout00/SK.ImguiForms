namespace SK.ImguiForms {
    ...
    internal class ImGuiInputHandler {
        ...
        readonly Func<IntPtr> contextProvider;
        ImGuiMouseCursor lastCursor;

        public ImGuiInputHandler(IntPtr hwnd, Func<IntPtr> contextProvider) {
            this.hwnd = hwnd;
        ...
        IntPtr MakeCurrent() {
            var context = contextProvider?.Invoke() ?? IntPtr.Zero;
            if(context != IntPtr.Zero && ImGui.GetCurrentContext() != context) {
