namespace SK.ImguiForms.Win32
{
    ...
    internal static class User32
    {
        ...
        [DllImport("user32.dll", SetLastError = true, EntryPoint = "SetWindowLong")]
        private static extern int SetWindowLong32bHandle(IntPtr hWnd, int nIndex, IntPtr value);

        [DllImport("user32.dll", SetLastError = true, EntryPoint = "SetWindowLongPtr")]
        private static extern IntPtr SetWindowLongPtrHandle(IntPtr hWnd, int nIndex, IntPtr value);
        ...
        public static IntPtr SetWindowLongHandle(IntPtr hWnd, int nIndex, IntPtr value)
        {
            if (IntPtr.Size == 4)
            {
                return new IntPtr(SetWindowLong32bHandle(hWnd, nIndex, value));
            }

            return SetWindowLongPtrHandle(hWnd, nIndex, value);
        }
